...
client.once("ready", () => {
  // حالة البوت: Streaming البنفسجية
  ...
  console.log("dev Foga store By 6yyj");
  console.log("discord.gg/foga");
  console.log("dev alshammari");
});
  ...
  try {
    ...
    if (interaction.isModalSubmit()) {
      ...
      if (interaction.customId === "modal_all") {
        membersToSend = guild.members.cache.filter(
